...
namespace LLBLGen.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the WebFunction entity</summary>
		public EntityQuery<WebFunctionEntity> WebFunction
		{
			get { return Create<WebFunctionEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the WebRole entity</summary>
		public EntityQuery<WebRoleEntity> WebRole
		{
			get { return Create<WebRoleEntity>(); }
		}
