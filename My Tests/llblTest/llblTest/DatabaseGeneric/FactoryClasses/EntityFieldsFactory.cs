...
namespace LLBLGen.FactoryClasses
{
	...
	{
		private static readonly Dictionary<LLBLGen.EntityType, string> _entityTypeNamesCache = new Dictionary<LLBLGen.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(LLBLGen.EntityType value in Enum.GetValues(typeof(LLBLGen.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(LLBLGen.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(LLBLGen.EntityType relatedEntityType)
		{
