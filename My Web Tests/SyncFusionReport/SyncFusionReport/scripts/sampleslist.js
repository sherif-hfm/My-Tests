...
window.SamplesList = [

    {
        ...
        "samples": [
			...
			{ "id": "27", "name": "Polar ", "action": "Polar", "childcount": "0" },
			 ...
			 { "id": "31", "name": "Vertical Chart", "action": "VerticalChart", "childcount": "0","type": "new" },
             { "id": "32", "name": "Trendlines", "action": "Trendlines", "childcount": "0" },
             { "id": "33", "name": "Live ", "action": "Live", "childcount": "0" },
             { "id": "34", "name": "Performance", "action": "LoadPoints", "childcount": "0"},
             { "id": "35", "name": "Export", "action": "Export", "childcount": "0" },            
             {
                 "id": "36", "name": "Technical Indicators", "action": "Rsi",  "childcount": "1", samples: [
                 //second hierarchy
      ...
      {
          "id": "37", "name": "3D ", "action": "Column3D", "childcount": "1", samples: [
               //second hierarchy
            ...
            {
                "id": "38", "name": "Chart Axes", "action": "MultipleAxes", "childcount": "1", samples: [
                     //second hierarchy
					  ...
					  { "id": "336", "name": "Smart Axis Labels", "action": "SmartAxisLabel", "childcount": "0"},
            ...
            {
                "id": "39", "name": "Chart Customization", "action": "Symbols","type": "update", "childcount": "1", samples: [
                //second hierarchy
                       ...
                       { "id": "345", "name": "Smart Labels", "action": "SmartLabels", "type" : "new", "childcount": "0" },
					   { "id": "346", "name": "Annotations", "action": "Annotations", "childcount": "0" },
                       { "id": "347", "name": "Legend Position", "action": "LegendPosition1", "childcount": "0"},
            ...
            {
                "id": "40", "name": "Data Binding", "action": "LocalBinding", "childcount": "1", samples: [
                //second hierarchy
            ...
            {
                "id": "41", "name": "User Interaction", "action": "Zooming", "childcount": "1", samples: [
                //second hierarchy
        ...
        "samples": [
            ...
            },
            {
                ...
                "samples": [
                    ...
                    { "id": "31", "name": "Data Caching", "controller": "Grid", "action": "DataCaching", "childcount": "0", "type": "update" },
			...
			{ "id": "36", "name": "GridLines", "action": "GridLines", "childcount": "0", "type":"new" },
	...
	{
	    "name": "Gantt", "id": "Gantt","Group": "DATA VISUALIZATION", "childcount": "1", "action": "Default", "samples": [
           ...
           { "id": "3", "name": "Editing", "action": "Editing", "childcount": "0" },
	        ...
	        { "id": "11", "name": "Schedule Modes", "action": "ScheduleModes", "childcount": "0"},
            ...
            { "id": "14", "name": "Column Chooser", "action": "ColumnChooser", "childcount": "0" }
	    ]
	},

    {
        ...
        { "id": "7", "name": "Details Template", "action": "TreeGridRowDetails", "childcount": "0"},
		{ "id": "8", "name": "Context Menu", "action": "TreeGridContextMenu", "childcount": "0" },
        { "id": "9", "name": "Column Filtering", "action": "TreeGridColumnFiltering", "childcount": "0"},
        { "id": "10", "name": "Column Chooser", "action": "TreeGridColumnChooser", "childcount": "0"},
        { "id": "11", "name": "Row Template", "action": "TreeGridRowTemplate", "childcount": "0" },
        { "id": "12", "name": "Row Drag And Drop", "action": "TreeGridRowDragAndDrop", "childcount": "0"},
        { "id": "13", "name": "Summary Row", "action": "TreeGridSummaryRow", "childcount": "0"},
        { "id": "14", "name": "Exporting", "action": "TreeGridExporting", "childcount": "0", "type": "new" },
        { "id": "15", "name": "Multiple Exporting", "action": "TreeGridMultipleExporting", "childcount": "0", "type": "new" },
        {
            "id": "16", "name": "AngularJS Templates", "action": "TreeGridAngularRowTemplate", "childcount": "1",
            "samples": [
    ...
    },
    {
        "name": "Schedule", "id": "Schedule", "childcount": "1", "action": "Default","Group": "DATA VISUALIZATION", "type": "update", "samples": [
             ...
             { "id": "25", "name": "TimeScale", "action": "TimeScale", "childcount": "0", "type": "new" },
             { "id": "4", "name": "Templates", "action": "templates", "childcount": "0" },
             {
              ...
              { "id": "8", "name": "FirstDayOfWeek", "action": "FirstDayOfWeek", "childcount": "0", "type": "new" },
			 { "id": "9", "name": "Categorize", "action": "CategorizeOption", "childcount": "0" },
             { "id": "10", "name": "Localization", "action": "localization", "childcount": "0" },
             { "id": "11", "name": "Custom View", "action": "CustomView", "childcount": "0", "type": "update" },
             { "id": "12", "name": "Custom Window", "action": "CustomWindow", "childcount": "0" },
             { "id": "13", "name": "Adaptive", "action": "AdaptiveSchedule", "childcount": "0" },
             { "id": "14", "name": "Context Menu", "action": "ContextMenu", "childcount": "0" },
             { "id": "15", "name": "Tooltip", "action": "Tooltip", "childcount": "0", "type": "new" },
             { "id": "16", "name": "Reminder", "action": "Reminder", "childcount": "0" },
             { "id": "17", "name": "SignalR", "action": "SignalR", "childcount": "0" },
			 { "id": "18", "name": "Appointment Search", "action": "AppointmentSearch", "childcount": "0" },
             { "id": "19", "name": "API's", "action": "API", "childcount": "0" },
             { "id": "20", "name": "Events", "action": "Events", "childcount": "0" },
             { "id": "21", "name": "RTL", "action": "RTL", "childcount": "0" },
             { "id": "22", "name": "KeyBoard Interaction", "action": "KeyBoardNavigation", "childcount": "0" },
             { "id": "23", "name": "Print", "action": "Print", "childcount": "0" },
             { "id": "24", "name": "Import & Export", "action": "ScheduleICSExport", "childcount": "0" }
...

    {
        ...
        "samples": [
            ...
            {
               "id": "3", "name": "Organizational Chart", "action": "TeamOrgChart", "childcount": "1", "type": "",
               "samples": [
                   ...
                   { "id": "3", "name": "Project Management", "action": "ProjectManagementOrgChart", "childcount": "0", "type": "" },
                   { "id": "4", "name": "University", "action": "UniversityOrgChart", "childcount": "0", "type": "" }
               ]
            },
            { "id": "4", "name": "Radial Tree", "action": "RadialTree", "childcount": "0", "type": "new" },
            { "id": "5", "name": "UML Diagram", "action": "UML", "childcount": "0", "type": "" },
            { "id": "6", "name": "SQL Binding", "action": "SQLBinding", "childcount": "0", "type": "" },
            { "id": "7", "name": "Localization", "action": "Localization", "childcount": "0", "type": "" },
            { "id": "8", "name": "Swimlane Diagram", "action": "Swimlane", "childcount": "0", "type": "" },
			{ "id": "9", "name": "DrawingTools", "action": "DrawingTools", "childcount": "0", "type": "" },
            { "id": "10", "name": "Overview", "action": "Overview", "childcount": "0", "type": "" },
            {
                "id": "11", "name": "Data Binding", "action": "LocalDataBinding", "childcount": "1", "type": "",
                "samples": [
                    { "id": "1", "name": "Local DataBinding", "action": "LocalDataBinding", "childcount": "0", "type": "" },
                    { "id": "2", "name": "Remote DataBinding", "action": "RemoteDataBinding", "childcount": "0", "type": "" },
                    { "id": "3", "name": "HTML DataBinding", "action": "HTMLDataBinding", "childcount": "0", "type": "" }
                ]
            },
            { "id": "12", "name": "Circuit Diagram", "action": "CircuitDiagram", "childcount": "0", "type": "" }
        ]
    },
...

     {
      ...
      {
          "name": "CircularGauge", "id": "CircularGauge", "Group": "DATA VISUALIZATION", "childcount": "1", "action": "Default", "samples": [
            { "id": "1", "name": "Default Functionalities", "action": "Default", "childcount": "0" },
     ...
     {
         "name": "LinearGauge", "id": "LinearGauge", "childcount": "1","Group": "DATA VISUALIZATION", "action": "Default", "samples": [
           { "id": "1", "name": "Default Functionalities", "action": "Default", "childcount": "0" },
           { "id": "2", "name": "Scales", "action": "Scales", "childcount": "0" },
      ...
      {
          "name": "DigitalGauge", "id": "DigitalGauge", "childcount": "1", "action": "Default","Group": "DATA VISUALIZATION", "samples": [
            { "id": "1", "name": "Default Functionalities", "action": "Default", "childcount": "0" },
     ...
     },
     {
         ...
         "samples": [
             ...
             { "id": "9", "name": "Backstage Page", "action": "BackStage", "childcount": "0" }
    ...
    // },		
{
        ...
        },
    {
     ...
     {
         "name": "OlapClient","Group": "BUSINESS INTELLIGENCE", "id": "OlapClient", "childcount": "1", "action": "Default","type": "update", "isResponsive":"false", "samples": [
              { "id": "1", "name": "Default Functionalities", "action": "Default", "childcount": "0" },
              ...
              { "id": "5", "name": "Defer Update", "action": "DeferUpdate", "childcount": "0", "type": "new" }
         ]
     },
     {
         "name": "PivotGrid", "id": "PivotGrid", "Group": "BUSINESS INTELLIGENCE", "childcount": "1", "action": "Default", "type": "update","isResponsive":"false", "samples": [
              ...
              { "id": "11", "name": "Cell Selection", "action": "cellSelection", "childcount": "0", "type": "" },
              { "id": "12", "name": "Conditional Formatting", "action": "ConditionalFormatting", "childcount": "0", "type": "" },
              { "id": "13", "name": "Exporting", "action": "Exporting", "childcount": "0", "type": "update" },
              {
                  "id": "14", "name": "Data Binding", "action": "Olap", "childcount": "1", "type": "update", "samples": [
                     { "id": "1", "name": "OLAP Binding", "action": "Olap", "childcount": "0", "type": "update" },
                     { "id": "2", "name": "Relational Binding", "action": "Pivot", "childcount": "0", "type": "update" }
                    ]
              },
			  { "id": "15", "name": "Grouping Bar", "action": "GroupingBar", "childcount": "0", "type": "" }
     ...
     },
     {
         ...
         { "id": "6", "name": "3DChart", "action": "3DChart", "childcount": "0", "type": "new" }
         ]
     },
     {
...

      {
...

       {
...

        {
         ...
         {
             "name": "Predictive Analytics", "Group": "DATA SCIENCE", "id": "Analytics", "childcount": "0", "action": "Sample", "samples": []
         },

    {
        ...
        "samples": [
            ...
            { "id": "24", "name": "API's", "action": "API", "childcount": "0", "type": "update" },
            { "id": "25", "name": "Client-Side Events", "action": "Events", "childcount": "0" },
            { "id": "26", "name": "Localization", "action": "Localization", "childcount": "0" },
            { "id": "27", "name": "File & Image Browser", "action": "FileAndImageBrowser", "childcount": "0" },
    ...
    },
    {
        ...
        "samples": [
            ...
            { "id": "3", "name": "API's", "action": "API", "childcount": "0" },
            { "id": "4", "name": "Client-Side Events", "action": "Events", "childcount": "0" },
            { "id": "5", "name": "Localization", "action": "Localization", "childcount": "0" },                        
            { "id": "6", "name": "RTL", "action": "RTL", "childcount": "0" },
            { "id": "7", "name": "Keyboard Interaction", "action": "KeyboardNavigation", "childcount": "0" }
        ]
    },
    ...
    },
    {
        ...
        "samples": [
            ...
            { "id": "3", "name": "Color Palette", "action": "PaletteModel", "childcount": "0", "type": "update" },
...

    {
     ...
     },
     {
         ...
         "samples": [
           ...
           { "id": "9", "name": "Template", "action": "Template", "childcount": "0" },
           { "id": "12", "name": "API's", "action": "API", "type":"update", "childcount": "0"},
           ...
           { "id": "18", "name": "Virtual Scrolling", "action": "VirtualScrolling", "type": "new", "childcount": "0"}
...

     {
         ...
         "samples": [
           ...
           "name": "ListView", "id": "ListView","childcount": "1", "Group": "LAYOUT", "action": "DefaultFunctionalities", "samples": [
             { "id": "1", "name": "Default Functionalities", "action": "DefaultFunctionalities", "childcount": "0" },
	   ...
	   {
	       "name": "UploadBox", "Group": "EDITORS","id": "UploadBox", "childcount": "1", "action": "DefaultFunctionalities", "samples": [
             { "id": "1", "name": "Default Functionalities", "action": "DefaultFunctionalities", "childcount": "0" },
            ...
            { "id": "7", "name": "Synchronous Upload", "action": "SynchronousUpload", "childcount": "0" },
             { "id": "8", "name": "Web API Service", "action": "WebAPIService", "childcount": "0", "type": "new" },
       ...
       },
     {
	   ...
	   },
       {
             ...
             { "id": "5", "name": "ColorPicker", "action": "ColorPicker", "childcount": "0" },
			 ...
			 { "id": "22", "name": "Ribbon", "action": "Ribbon", "childcount": "0" },
       ...
       },
        {
            ...
            "samples": [
			  ...
			  { "id": "21", "name": "Rating", "action": "Rating", "childcount": "0" },
			  { "id": "22", "name": "Ribbon", "action": "Ribbon", "childcount": "0","type": "new" },
              { "id": "23", "name": "RichTextEditor", "action": "RichTextEditor", "childcount": "0" },
