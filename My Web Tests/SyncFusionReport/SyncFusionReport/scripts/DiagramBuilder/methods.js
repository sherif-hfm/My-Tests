...
function clearText() {
    ...
    if (document.getElementById("searchbox_icon-mini"))
        document.getElementById("searchbox_icon-mini").style.backgroundImage = 'url("../Content/DiagramBuilder/images/Search-Find.png")';
    if (document.getElementById("searchbox_icon-maxi"))
        document.getElementById("searchbox_icon-maxi").style.backgroundImage = 'url("../Content/DiagramBuilder/images/Search-Find.png")';
...
function onSearchBoxTextChange() {
    ...
    if (key && key == "") {
        ...
        if (document.getElementById("searchbox_icon-mini"))
            document.getElementById("searchbox_icon-mini").style.backgroundImage = 'url("../Content/DiagramBuilder/images/Close.png")';
    }
    setToolTip();
}
...
function onSearchBoxTextChange_maxi() {
    ...
    if (key.length > 0) {
        ...
        if (key == "") {
            ...
            document.getElementById("searchbox_icon-maxi").style.backgroundImage = 'url("../Content/DiagramBuilder/images/Close.png")';
        }
    }
