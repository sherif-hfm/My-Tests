...
function exportDiagram() {
    ...
    var region = $("#exportDialog_exportmode").ejDropDownList("instance").selectedTextValue;
    switch (region) {
        case "Content":
            region = "content";
            break;
    ...
    var format = $("#exportDialog_exportformat").ejDropDownList("instance").selectedTextValue;
    switch (format) {
        case "JPG":
            format = "jpg";
            break;
