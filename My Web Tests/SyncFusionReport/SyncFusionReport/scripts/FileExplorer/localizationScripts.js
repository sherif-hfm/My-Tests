    ...
    switch (args.value) {
        case "es-ES":
            $("#LayoutSection_ControlsSection_fileexplorer").ejFileExplorer("option", {
                gridSettings: { columns: [{ field: "name", headerText: "nombre", width: 160 }, { field: "type", headerText: "tipo", width: 95 }, { field: "dateModified", headerText: "fecha de modificación", width: 160 }, { field: "size", headerText: "tamaño", width: 50 }] }
            });
            break;
        case "de-DE":
            $("#LayoutSection_ControlsSection_fileexplorer").ejFileExplorer("option", {
                gridSettings: { columns: [{ field: "name", headerText: "Name", width: 160 }, { field: "type", headerText: "Art", width: 95 }, { field: "dateModified", headerText: "Änderungsdatum", width: 160 }, { field: "size", headerText: "Größe", width: 50 }] }
            });
            break;
        case "en-US":
            $("#LayoutSection_ControlsSection_fileexplorer").ejFileExplorer("option", {
                gridSettings: { columns: [{ field: "name", headerText: "Name", width: 160 }, { field: "type", headerText: "Type", width: 95 }, { field: "dateModified", headerText: "Date Modified", width: 160 }, { field: "size", headerText: "Size", width: 50 }] }
            });
            break;
        case "ar-SA":
            $("#LayoutSection_ControlsSection_fileexplorer").ejFileExplorer("option", {
                gridSettings: { columns: [{ field: "name", headerText: "اسم", width: 160 }, { field: "type", headerText: "اكتب", width: 95 }, { field: "dateModified", headerText: "تاريخ التعديل", width: 160 }, { field: "size", headerText: "حجم", width: 50 }] }
            });
            break;
    }
