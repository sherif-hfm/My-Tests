<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="FineUploaderTest.Index" %>
    ...
    <script type="text/javascript">
        $('#fine-uploader-gallery').fineUploader({
            ...
            request: {
                ...
                params: {Operation: "Add", OperationId: "1"}
            },
            thumbnails: {
                placeholders:
                    {
            ...
            deleteFile: {
                enabled: true,
                endpoint: '/Uploader.ashx', params: { Operation: "Del", OperationId: "2" },
                method: "POST"
            }
        });
    </script>
